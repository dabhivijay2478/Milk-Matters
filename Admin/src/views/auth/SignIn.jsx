...
export default function SignIn() {
  ...
  const handleLogin = async () => {
    try {
      ...
      const { success, message, role, userId, name } = response.data;
      ...
      if (success) {
        ...
        // Redirect to the AdminLayout after successful login
  ...
  return (
    <div className="mt-16 mb-16 flex h-full w-full items-center justify-center px-2 md:mx-0 md:px-0 lg:mb-10 lg:items-center lg:justify-start">
      <div className="mt-[10vh] w-full max-w-full flex-col items-center md:pl-4 lg:pl-0 xl:max-w-[420px]">
        ...
        <label className="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none ${
